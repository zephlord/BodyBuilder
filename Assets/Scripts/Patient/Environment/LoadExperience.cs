...
///<summary>
/// loads the experience chosen by a caregiver into the experience
///</sumary>
public class LoadExperience : MonoBehaviour {
	...
	// download the assetbundle from the server and load the environment
	...
	// when the scene is loaded, make sure the main camera is deleted in the loaded scene
